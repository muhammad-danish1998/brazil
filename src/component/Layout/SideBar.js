    ...
    <div class="row flex-nowrap">
        <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark">
            <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                <NavLink to={"/dashboard"} class="d-flex align-items-center pb-3 mb-md-0 me-md-auto text-white navbar-brand text-decoration-none">
                        <img src={logo} className='img-fluid logo-img' alt='logo' width={70}   />
                    </NavLink>
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                    <li  class="nav-item ">
                        <NavLink to={"/dashboard"}  class="nav-link px-0 align-middle">
                            <i class="fs-4 bi-speedometer2"></i> <span class="ms-1 d-none d-sm-inline">Dashboard</span>
                             </NavLink>
                    </li>
                    <li class="nav-item ">
                        <NavLink to={"/patients"} class="nav-link align-middle px-0">
                            <i class="fs-4 bi-person"></i> <span class="ms-1 d-none d-sm-inline">Patients</span>
                        </NavLink>
                    </li>
                </ul>
                <hr />
                <div class="dropdown pb-4">
                    <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
                        <img src={currentUserData?.logo || avatar} alt="hugenerd" width="30" height="30" class="rounded-circle" />
